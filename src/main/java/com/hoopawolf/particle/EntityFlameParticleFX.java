...
public class EntityFlameParticleFX extends EntityFlameFX {
    ...
    public EntityFlameParticleFX(World world, double x, double y, double z, double motionY, double angle) {
