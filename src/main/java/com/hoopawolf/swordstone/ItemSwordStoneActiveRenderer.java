...
public class ItemSwordStoneActiveRenderer implements IItemRenderer {

    private SwordStoneActiveModel model;

    public ItemSwordStoneActiveRenderer() {
        model = new SwordStoneActiveModel();
    }
