...
public class VulcansRevengeSword extends ItemSword {

    public VulcansRevengeSword(Item.ToolMaterial par2EnumToolMaterial) {
        super(par2EnumToolMaterial);
        setUnlocalizedName("vulcansRevengeSword");
        setCreativeTab(VulcansRevenge.tabVulcansRevenge);
        setTextureName(Reference.MOD_ID + ":" + "vulcansrevenge");
    }
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
        ...
        if (!p_77659_3_.capabilities.isCreativeMode && p_77659_3_.isSneaking()) {
            ...
            ItemStack newSword = new ItemStack(SwordManager.vulcansRevengeSwordHeavy);
